...
export default function PlantCard({ plant, hotspots }) {
  if (!plant) {
  ...
  return (
    <div>
      ...
      <p style={{color:"var(--muted)",marginTop:12}}>{plant.description || "No description provided."}</p>

      <div className="gallery">
        {(plant.images || []).slice(0,2).map((src, i)=> <img key={i} src={src} alt={plant.name + i} />)}
